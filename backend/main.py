...
app = FastAPI(
    ...
    description="PetCareConnect: Pet services platform connecting owners with vets and groomers",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "petcareconnect"}
